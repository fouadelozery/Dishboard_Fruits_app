...
import 'package:dishboard_fruits_app/features/view_order/presentation/views/widgets/update_order_builder.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: Scaffold(
        ...
        body: UpdateOrderBuilder(child: OrderViewBodyBlocBuilder()),
      ),
    );
  }
}
